...
if (isset($_SESSION['error'])) {
    ...
    require 'config.php';
    if(update($conn,$_POST['id'], $_POST['name'], $_POST['email'], $_POST['rollno'], $_POST['class'], $target)){
        $_SESSION['mesg']= "id: ".$_POST['id']." Updated";
    }else{
        $_SESSION['mesg']= "Unable to update id: ".$_POST['id'];
    }
